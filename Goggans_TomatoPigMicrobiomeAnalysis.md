Goggans et al., Microbiology Spectrum 2022, Microbiome Analysis Code
================
Mallory Goggans, Cristian D. Quiroz-Moreno, Emma Bilbrey and Jessica
Cooperstone

-   <a href="#introduction" id="toc-introduction">Introduction</a>
    -   <a href="#authors" id="toc-authors">Authors</a>
    -   <a href="#load-libraries" id="toc-load-libraries">Load libraries</a>
    -   <a href="#set-seed" id="toc-set-seed">Set seed</a>
    -   <a href="#read-in-metadata" id="toc-read-in-metadata">Read in
        metadata</a>
-   <a href="#genera-level-annotation"
    id="toc-genera-level-annotation">Genera-level annotation</a>
    -   <a href="#data-filtering" id="toc-data-filtering">Data filtering</a>
        -   <a href="#remove-inplausible-phyla"
            id="toc-remove-inplausible-phyla">Remove inplausible phyla</a>
        -   <a href="#counting-missing-data" id="toc-counting-missing-data">Counting
            missing data</a>
        -   <a href="#filter-for-33-missingness"
            id="toc-filter-for-33-missingness">Filter for &lt;33% missingness</a>
    -   <a href="#microbiome-profile" id="toc-microbiome-profile">Microbiome
        profile</a>
        -   <a href="#wrangling" id="toc-wrangling">Wrangling</a>
        -   <a href="#count-genera" id="toc-count-genera">Count genera</a>
        -   <a href="#most-prevalent-genera" id="toc-most-prevalent-genera">Most
            prevalent genera</a>
    -   <a href="#rarefaction-curves" id="toc-rarefaction-curves">Rarefaction
        curves</a>
        -   <a href="#create-tax-and-otu-tables"
            id="toc-create-tax-and-otu-tables">Create tax and OTU tables</a>
        -   <a href="#create-metadata" id="toc-create-metadata">Create metadata</a>
        -   <a href="#renaming-samples" id="toc-renaming-samples">Renaming
            samples</a>
        -   <a href="#creating-a-phyloseq-object"
            id="toc-creating-a-phyloseq-object">Creating a phyloseq object</a>
        -   <a href="#filtering-taxa" id="toc-filtering-taxa">Filtering taxa</a>
        -   <a href="#creating-rarefaction-curves"
            id="toc-creating-rarefaction-curves">Creating rarefaction curves</a>
    -   <a href="#krona-plots-for-exploratory-analysis"
        id="toc-krona-plots-for-exploratory-analysis">Krona plots for
        exploratory analysis</a>
    -   <a href="#permanova" id="toc-permanova">PERMANOVA</a>
        -   <a href="#all-samples-full-model" id="toc-all-samples-full-model">All
            samples, full model</a>
        -   <a href="#post-hoc-permanova-within-each-diet"
            id="toc-post-hoc-permanova-within-each-diet">Post Hoc PERMANOVA within
            Each Diet</a>
            -   <a href="#within-control-diet-only"
                id="toc-within-control-diet-only">Within Control Diet Only</a>
                -   <a href="#control-t1-vs-control-t2"
                    id="toc-control-t1-vs-control-t2">Control T1 vs Control T2</a>
                -   <a href="#control-t1-vs-t3" id="toc-control-t1-vs-t3">Control T1 vs
                    T3</a>
                -   <a href="#control-t2-vs-t3" id="toc-control-t2-vs-t3">Control T2 vs
                    T3</a>
            -   <a href="#tomato" id="toc-tomato">Tomato</a>
                -   <a href="#tomato-t1-vs-tomato-t2" id="toc-tomato-t1-vs-tomato-t2">Tomato
                    T1 vs Tomato T2</a>
                -   <a href="#tomato-t1-vs-t3" id="toc-tomato-t1-vs-t3">tomato T1 vs T3</a>
                -   <a href="#tomato-t2-vs-t3" id="toc-tomato-t2-vs-t3">tomato T2 vs T3</a>
        -   <a href="#subset-by-time" id="toc-subset-by-time">Subset by time</a>
            -   <a href="#day-0" id="toc-day-0">Day 0</a>
            -   <a href="#day-7" id="toc-day-7">Day 7</a>
            -   <a href="#day-14" id="toc-day-14">Day 14</a>
    -   <a href="#pcoa-beta-diversity" id="toc-pcoa-beta-diversity">PCoA Beta
        Diversity</a>
        -   <a href="#all-samples" id="toc-all-samples">All samples</a>
            -   <a href="#facet-by-time-point" id="toc-facet-by-time-point">Facet by
                time point</a>
            -   <a href="#facet-by-diet" id="toc-facet-by-diet">Facet by diet</a>
        -   <a href="#subset" id="toc-subset">Subset</a>
            -   <a href="#control-only" id="toc-control-only">Control only</a>
            -   <a href="#tomato-only" id="toc-tomato-only">Tomato only</a>
            -   <a href="#day-0-only" id="toc-day-0-only">Day 0 Only</a>
            -   <a href="#day-7-only" id="toc-day-7-only">Day 7 Only</a>
            -   <a href="#day-14-only" id="toc-day-14-only">Day 14 Only</a>
    -   <a href="#alpha-diversity" id="toc-alpha-diversity">Alpha Diversity</a>
        -   <a href="#wrangling-1" id="toc-wrangling-1">Wrangling</a>
        -   <a href="#calculate-alpha-diversity"
            id="toc-calculate-alpha-diversity">Calculate alpha diversity</a>
        -   <a href="#plotting" id="toc-plotting">Plotting</a>
        -   <a href="#statistics" id="toc-statistics">Statistics</a>
    -   <a href="#aldex2" id="toc-aldex2">ALDEx2</a>
        -   <a href="#wrangling-2" id="toc-wrangling-2">Wrangling</a>
        -   <a href="#subset-by-time-1" id="toc-subset-by-time-1">Subset by Time</a>
            -   <a href="#day-0-1" id="toc-day-0-1">Day 0</a>
            -   <a href="#day-7-1" id="toc-day-7-1">Day 7</a>
            -   <a href="#day-14-1" id="toc-day-14-1">Day 14</a>
        -   <a href="#subset-by-diet" id="toc-subset-by-diet">Subset by diet</a>
            -   <a href="#control" id="toc-control">Control</a>
            -   <a href="#tomato-1" id="toc-tomato-1">Tomato</a>
-   <a href="#phyla-level-annotation"
    id="toc-phyla-level-annotation">Phyla-level annotation</a>
    -   <a href="#data-filtering-1" id="toc-data-filtering-1">Data filtering</a>
        -   <a href="#remove-inplausible-phyla-1"
            id="toc-remove-inplausible-phyla-1">Remove inplausible phyla</a>
        -   <a href="#counting-missing-data-1"
            id="toc-counting-missing-data-1">Counting missing data</a>
        -   <a href="#filter-for-33-missingness-1"
            id="toc-filter-for-33-missingness-1">Filter for &lt;33% missingness</a>
    -   <a href="#microbiome-profile-1" id="toc-microbiome-profile-1">Microbiome
        profile</a>
        -   <a href="#wrangling-3" id="toc-wrangling-3">Wrangling</a>
        -   <a href="#count-phyla" id="toc-count-phyla">Count phyla</a>
        -   <a href="#most-prevalent-phyla" id="toc-most-prevalent-phyla">Most
            prevalent phyla</a>
    -   <a href="#permanova-1" id="toc-permanova-1">PERMANOVA</a>
        -   <a href="#all-samples-full-model-1"
            id="toc-all-samples-full-model-1">All samples, full model</a>
        -   <a href="#post-hoc-permanova-within-time"
            id="toc-post-hoc-permanova-within-time">Post Hoc PERMANOVA within
            Time</a>
            -   <a href="#within-control-diet-only-1"
                id="toc-within-control-diet-only-1">Within Control Diet Only</a>
                -   <a href="#control-t1-vs-control-t2-1"
                    id="toc-control-t1-vs-control-t2-1">Control T1 vs Control T2</a>
                -   <a href="#control-t1-vs-control-t3"
                    id="toc-control-t1-vs-control-t3">Control T1 vs Control T3</a>
                -   <a href="#control-t2-vs-control-t3"
                    id="toc-control-t2-vs-control-t3">Control T2 vs Control T3</a>
            -   <a href="#within-tomato-diet-only"
                id="toc-within-tomato-diet-only">Within Tomato Diet Only</a>
        -   <a href="#subset-by-time-2" id="toc-subset-by-time-2">Subset by time</a>
            -   <a href="#day-0-only-1" id="toc-day-0-only-1">Day 0 Only</a>
            -   <a href="#day-7-only-1" id="toc-day-7-only-1">Day 7 Only</a>
            -   <a href="#day-14-only-1" id="toc-day-14-only-1">Day 14 Only</a>
    -   <a href="#pcoa-beta-diversity-1" id="toc-pcoa-beta-diversity-1">PCoA
        Beta Diversity</a>
        -   <a href="#all-samples-1" id="toc-all-samples-1">All samples</a>
            -   <a href="#facet-by-time-point-1" id="toc-facet-by-time-point-1">Facet by
                time point</a>
            -   <a href="#facet-by-diet-1" id="toc-facet-by-diet-1">Facet by diet</a>
        -   <a href="#subset-1" id="toc-subset-1">Subset</a>
            -   <a href="#control-only-1" id="toc-control-only-1">Control only</a>
            -   <a href="#tomato-only-1" id="toc-tomato-only-1">Tomato only</a>
            -   <a href="#day-0-only-2" id="toc-day-0-only-2">Day 0 Only</a>
            -   <a href="#day-7-only-2" id="toc-day-7-only-2">Day 7 Only</a>
            -   <a href="#day-14-only-2" id="toc-day-14-only-2">Day 14 Only</a>
    -   <a href="#bacteroidotabacteriodetes-bacilottafirmicutes-and-their-ratio"
        id="toc-bacteroidotabacteriodetes-bacilottafirmicutes-and-their-ratio">Bacteroidota/Bacteriodetes,
        Bacilotta/Firmicutes, and their ratio</a>
        -   <a href="#wrangling-4" id="toc-wrangling-4">Wrangling</a>
        -   <a href="#plotting-1" id="toc-plotting-1">Plotting</a>
        -   <a href="#b-to-f-ratio" id="toc-b-to-f-ratio">B to F Ratio</a>
            -   <a href="#plotting-2" id="toc-plotting-2">Plotting</a>
            -   <a href="#statistics-1" id="toc-statistics-1">Statistics</a>
        -   <a href="#bacteroidetes-and-firmicutes"
            id="toc-bacteroidetes-and-firmicutes">Bacteroidetes and Firmicutes</a>
            -   <a href="#plotting-3" id="toc-plotting-3">Plotting</a>
            -   <a href="#statistics-2" id="toc-statistics-2">Statistics</a>
                -   <a href="#bacteroidetes" id="toc-bacteroidetes">Bacteroidetes</a>
                -   <a href="#firmicutes" id="toc-firmicutes">Firmicutes</a>
    -   <a href="#alpha-diversity-1" id="toc-alpha-diversity-1">Alpha
        Diversity</a>
        -   <a href="#wrangling-5" id="toc-wrangling-5">Wrangling</a>
        -   <a href="#calculate-alpha-diversity-1"
            id="toc-calculate-alpha-diversity-1">Calculate alpha diversity</a>
        -   <a href="#plotting-4" id="toc-plotting-4">Plotting</a>
        -   <a href="#statistics-3" id="toc-statistics-3">Statistics</a>
    -   <a href="#aldex2-1" id="toc-aldex2-1">ALDEx2</a>
        -   <a href="#wrangling-6" id="toc-wrangling-6">Wrangling</a>
        -   <a href="#subset-by-time-3" id="toc-subset-by-time-3">Subset by Time</a>
            -   <a href="#day-0-2" id="toc-day-0-2">Day 0</a>
            -   <a href="#day-7-2" id="toc-day-7-2">Day 7</a>
            -   <a href="#day-14-2" id="toc-day-14-2">Day 14</a>
        -   <a href="#subset-by-diet-1" id="toc-subset-by-diet-1">Subset by diet</a>
            -   <a href="#control-1" id="toc-control-1">Control</a>
            -   <a href="#tomato-2" id="toc-tomato-2">Tomato</a>
    -   <a href="#fiddling-with-figures" id="toc-fiddling-with-figures">Fiddling
        with figures</a>
        -   <a href="#fig2-beta-diversity" id="toc-fig2-beta-diversity">Fig2 Beta
            diversity</a>
        -   <a href="#fig3-btob" id="toc-fig3-btob">Fig3 BtoB</a>
        -   <a href="#fig4-alpha-diversity" id="toc-fig4-alpha-diversity">Fig4
            alpha-diversity</a>

# Introduction

Diets rich in fruits and vegetables have been shown to exert positive
effects on the gut microbiome. However, little is known about the
specific effect of individual fruits or vegetables on gut microbe
profiles. This study aims to elucidate the effects of tomato consumption
on the gut microbiome, as tomatoes account for 22% of vegetable
consumption in Western diets, and their consumption has been associated
with positive health outcomes. Using piglets as a physiologically
relevant model of human metabolism, 20 animals were assigned to either a
control or a tomato powder-supplemented diet (both macronutrient matched
and isocaloric) for 14 days. The microbiome was sampled rectally at
three time points: day 0 (baseline), day 7 (midpoint), and day 14 (end
of study). DNA was sequenced using shotgun metagenomics, and reads were
annotated using MG-RAST. There were no differences in body weight or
feed intake between our two treatment groups. There was a microbial
shift which included a higher ratio of Bacteroidota to Bacillota
(formerly known as Bacteroidetes and Firmicutes, respectively) and
higher alpha-diversity in tomato-fed animals, indicating a shift to a
more desirable phenotype. Analyses at both the phylum and genus levels
showed global microbiome profile changes (permutational multivariate
analysis of variance [PERMANOVA](#permanova-1), P ≤ 0.05) over time but
not with tomato consumption. These data suggest that short-term tomato
consumption can beneficially influence the gut microbial profile,
warranting further investigation in humans.

<https://doi.org/10.1128/spectrum.02506-22>

In this document you can find all our code and analysis for this paper.

### Authors

Mallory L. Goggans1, Emma A. Bilbrey2, Cristian D. Quiroz-Moreno2, David
M. Francis3, Sheila K. Jacobi4, Jasna Kovac5,6, Jessica L.
Cooperstone1,2\*

1Food Science and Technology, The Ohio State University, Columbus, OH
43210. 2Horticulture and Crop Science, The Ohio State University,
Columbus, OH 43210. 3Horticulture and Crop Science, The Ohio State
University, Wooster, OH 44691. 4Animal Sciences, The Ohio State
University, Columbus, OH 43210. 5Food Science, The Pennsylvania State
University, University Park, PA, 16802. 6 Microbiome Center, Huck
Institutes of the Life Sciences, The Pennsylvania State University,
University Park, PA 16802.

\*To whom correspondence should be addressed, <cooperstone.1@osu.edu>
...
# ok we were optimistic that this would get out in 2021 :(
```
...
-   Goggans et al., Microbiology Spectrum, 2022, doi:
    <https://doi.org/10.1128/spectrum.02506-22>

The data read in chunk below enables loading our data without any
outside-of-R handling. In TableS2.SampleMetadata tab of Supplementary
Information you can find our metadat, which you can get in our
[paper](https://doi.org/10.1128/spectrum.02506-22), or
[here](https://journals.asm.org/doi/suppl/10.1128/spectrum.02506-22/suppl_file/spectrum.02506-22-s0001.xlsx).

``` r
# upload metadata
AllSamples.Metadata <- read_excel("data/spectrum.02506-22-s0001.xlsx",
...
Read in genera level data, annotated from MG-RAST. In TableS4.Genera tab
of Supplementary Information you can find genera level assignment, which
you can get in our [paper](https://doi.org/10.1128/spectrum.02506-22),
or
[here](https://journals.asm.org/doi/suppl/10.1128/spectrum.02506-22/suppl_file/spectrum.02506-22-s0001.xlsx)

``` r
Genus.AllSamples.Counts <- read_excel("data/spectrum.02506-22-s0001.xlsx",
...
![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-11-2.png)<!-- -->
...
```
    ...
    ## # A tibble: 5 × 10
    ##   domain    phylum      class order family genus Shotg…¹ Shotg…² Shotg…³ Shotg…⁴
    ##   <chr>     <chr>       <chr> <chr> <chr>  <chr>   <dbl>   <dbl>   <dbl>   <dbl>
    ## 1 Viruses   unclassifi… uncl… Caud… Podov… AHJD…      29       0     153       0
    ## 2 Bacteria  Firmicutes  Baci… Lact… Aeroc… Abio…    5067    5661    4117    1576
    ## 3 Eukaryota unclassifi… uncl… uncl… uncla… Acan…       0       0       0       1
    ## 4 Bacteria  Cyanobacte… uncl… uncl… uncla… Acar…     271     416     267     131
    ## 5 Bacteria  Firmicutes  Clos… Clos… Rumin… Acet…    1988    2981    2071    1012
    ## # … with abbreviated variable names
    ## #   ¹​`ShotgunWGS-ControlPig6GutMicrobiome-Day14`,
    ## #   ²​`ShotgunWGS-ControlPig8GutMicrobiome-Day0`,
    ## #   ³​`ShotgunWGS-ControlPig3GutMicrobiome-Day14`,
    ## #   ⁴​`ShotgunWGS-TomatoPig14GutMicrobiome-Day7`
...
```
    ...
    ## # A tibble: 6 × 60
    ##   ShotgunWGS-C…¹ Shotg…² Shotg…³ Shotg…⁴ Shotg…⁵ Shotg…⁶ Shotg…⁷ Shotg…⁸ Shotg…⁹
    ##            <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>
    ## 1             29       0     153       0      14       1       2       0       0
    ## 2           5067    5661    4117    1576    3708    1159    2495    1636    4534
    ## 3              0       0       0       1       0       0       0       0       0
    ## 4            271     416     267     131     230     146     133     141     338
    ## 5           1988    2981    2071    1012    1991     585    1538     812    2670
    ## 6             66      86      60      41      64      33      51      43     144
    ## # … with 51 more variables: `ShotgunWGS-TomatoPig18GutMicrobiome-Day0` <dbl>,
    ## #   `ShotgunWGS-ControlPig10GutMicrobiome-Day0` <dbl>,
    ## #   `ShotgunWGS-ControlPig7GutMicrobiome-Day0` <dbl>,
    ## #   `ShotgunWGS-ControlPig8GutMicrobiome-Day14` <dbl>,
    ## #   `ShotgunWGS-TomatoPig11GutMicrobiome-Day0` <dbl>,
    ## #   `ShotgunWGS-TomatoPig19GutMicrobiome-Day0` <dbl>,
    ## #   `ShotgunWGS-TomatoPig17GutMicrobiome-Day14` <dbl>, …
...
shorter ones. New names will be created as *Type_Pig_Day*. We are also
...
``` r
ggsave("Figures/BetaDiversity_PCoA_Genera_allsamples.svg", 
...
``` r
ggsave("Figures/BetaDiversity_PCoA_Genera_FacetByTimePoint.svg", 
...
``` r
ggsave("Figures/BetaDiversity_PCoA_Genera_FacetByDiet.svg", 
...
``` r
ggsave("Figures/AlphaDiversityGenera_ByDiet_Boxplot.svg", 
...
``` r
ggsave("Figures/AlphaDiversityGenera_ByTime_Boxplot.svg", 
...
```
    ...
    ##    domain    phylum     class order family genus Shotg…¹ Shotg…² Shotg…³ Shotg…⁴
    ##    <chr>     <chr>      <chr> <chr> <chr>  <chr>   <dbl>   <dbl>   <dbl>   <dbl>
    ##  1 Viruses   unclassif… uncl… Caud… Podov… AHJD…      29       0     153       0
    ##  2 Bacteria  Firmicutes Baci… Lact… Aeroc… Abio…    5067    5661    4117    1576
    ##  3 Eukaryota unclassif… uncl… uncl… uncla… Acan…       0       0       0       1
    ##  4 Bacteria  Cyanobact… uncl… uncl… uncla… Acar…     271     416     267     131
    ##  5 Bacteria  Firmicutes Clos… Clos… Rumin… Acet…    1988    2981    2071    1012
    ##  6 Bacteria  Proteobac… Alph… Rhod… Aceto… Acet…      66      86      60      41
    ##  7 Bacteria  Firmicutes Clos… Hala… Halob… Acet…    1036    1373    1015     399
    ##  8 Bacteria  Tenericut… Moll… Acho… Achol… Acho…     779    1269     817     391
    ##  9 Bacteria  Proteobac… Beta… Burk… Alcal… Achr…     192     298     197      90
    ## 10 Bacteria  Firmicutes Nega… Sele… Acida… Acid…   50181   39909   31994   11378
    ## # … with abbreviated variable names
    ## #   ¹​`ShotgunWGS-ControlPig6GutMicrobiome-Day14`,
    ## #   ²​`ShotgunWGS-ControlPig8GutMicrobiome-Day0`,
    ## #   ³​`ShotgunWGS-ControlPig3GutMicrobiome-Day14`,
...
Read in phyla level data, annotated from MG-RAST. In TableS3.Phyla tab
of Supplementary Information you can find phyla level assignment, which
you can get in our [paper](https://doi.org/10.1128/spectrum.02506-22),
or
[here](https://journals.asm.org/doi/suppl/10.1128/spectrum.02506-22/suppl_file/spectrum.02506-22-s0001.xlsx)

``` r
Phyla.Counts <- read_excel("data/spectrum.02506-22-s0001.xlsx",
                                       sheet = "TableS3.Phyla")
```
...
```
    ...
    ## tibble [62 × 63] (S3: tbl_df/tbl/data.frame)
    ##  $ domain                                    : chr [1:62] "Bacteria" "Bacteria" "Eukaryota" "Bacteria" ...
    ##  $ phylum                                    : chr [1:62] "Acidobacteria" "Actinobacteria" "Apicomplexa" "Aquificae" ...
    ##  $ ShotgunWGS-ControlPig6GutMicrobiome-Day14 : num [1:62] 2874 186789 231 1953 368 ...
    ##  $ ShotgunWGS-ControlPig8GutMicrobiome-Day0  : num [1:62] 3717 277130 384 2254 992 ...
    ##  $ ShotgunWGS-ControlPig3GutMicrobiome-Day14 : num [1:62] 2663 126155 190 1642 386 ...
    ##  $ ShotgunWGS-TomatoPig14GutMicrobiome-Day7  : num [1:62] 880 39557 168 647 211 ...
    ##  $ ShotgunWGS-ControlPig5GutMicrobiome-Day7  : num [1:62] 2016 142345 171 1418 400 ...
    ##  $ ShotgunWGS-TomatoPig18GutMicrobiome-Day7  : num [1:62] 1377 181295 101 658 201 ...
    ##  $ ShotgunWGS-TomatoPig16GutMicrobiome-Day7  : num [1:62] 1570 58263 224 892 340 ...
    ##  $ ShotgunWGS-ControlPig10GutMicrobiome-Day7 : num [1:62] 1298 109273 287 900 211 ...
    ##  $ ShotgunWGS-ControlPig2GutMicrobiome-Day0  : num [1:62] 3114 159425 529 2095 764 ...
    ##  $ ShotgunWGS-TomatoPig18GutMicrobiome-Day0  : num [1:62] 2604 168472 170 1422 393 ...
    ##  $ ShotgunWGS-ControlPig10GutMicrobiome-Day0 : num [1:62] 3118 163425 231 1192 426 ...
    ##  $ ShotgunWGS-ControlPig7GutMicrobiome-Day0  : num [1:62] 2796 70967 389 1137 605 ...
    ##  $ ShotgunWGS-ControlPig8GutMicrobiome-Day14 : num [1:62] 2222 91465 325 1561 364 ...
    ##  $ ShotgunWGS-TomatoPig11GutMicrobiome-Day0  : num [1:62] 2136 68481 402 1377 691 ...
    ##  $ ShotgunWGS-TomatoPig19GutMicrobiome-Day0  : num [1:62] 2017 207693 143 1265 361 ...
    ##  $ ShotgunWGS-TomatoPig17GutMicrobiome-Day14 : num [1:62] 836 26050 147 633 212 ...
    ##  $ ShotgunWGS-ControlPig9GutMicrobiome-Day14 : num [1:62] 2612 172091 181 1645 393 ...
    ##  $ ShotgunWGS-ControlPig10GutMicrobiome-Day14: num [1:62] 2136 122681 250 1536 445 ...
    ##  $ ShotgunWGS-TomatoPig19GutMicrobiome-Day7  : num [1:62] 1090 78218 168 774 304 ...
    ##  $ ShotgunWGS-ControlPig5GutMicrobiome-Day14 : num [1:62] 2693 263950 266 1713 577 ...
    ##  $ ShotgunWGS-ControlPig2GutMicrobiome-Day7  : num [1:62] 3420 101192 582 2369 766 ...
    ##  $ ShotgunWGS-ControlPig6GutMicrobiome-Day7  : num [1:62] 2216 159323 115 1383 303 ...
    ##  $ ShotgunWGS-TomatoPig12GutMicrobiome-Day0  : num [1:62] 2146 78205 221 1265 390 ...
    ##  $ ShotgunWGS-TomatoPig14GutMicrobiome-Day0  : num [1:62] 732 77377 292 585 223 ...
    ##  $ ShotgunWGS-ControlPig7GutMicrobiome-Day14 : num [1:62] 2079 142139 322 1335 392 ...
    ##  $ ShotgunWGS-TomatoPig11GutMicrobiome-Day14 : num [1:62] 570 25927 180 425 270 ...
    ##  $ ShotgunWGS-TomatoPig20GutMicrobiome-Day0  : num [1:62] 2472 82091 415 1534 647 ...
    ##  $ ShotgunWGS-ControlPig9GutMicrobiome-Day0  : num [1:62] 1607 88397 432 1085 423 ...
    ##  $ ShotgunWGS-TomatoPig11GutMicrobiome-Day7  : num [1:62] 278 17451 96 150 107 ...
    ##  $ ShotgunWGS-TomatoPig13GutMicrobiome-Day7  : num [1:62] 1100 56205 157 984 306 ...
    ##  $ ShotgunWGS-TomatoPig17GutMicrobiome-Day0  : num [1:62] 1562 74553 171 780 238 ...
    ##  $ ShotgunWGS-TomatoPig19GutMicrobiome-Day14 : num [1:62] 765 47957 182 551 237 ...
    ##  $ ShotgunWGS-TomatoPig13GutMicrobiome-Day0  : num [1:62] 2182 124473 280 1483 476 ...
    ##  $ ShotgunWGS-ControlPig2GutMicrobiome-Day14 : num [1:62] 3329 116448 325 2149 703 ...
    ##  $ ShotgunWGS-ControlPig1GutMicrobiome-Day7  : num [1:62] 1920 55849 156 1234 408 ...
    ##  $ ShotgunWGS-TomatoPig15GutMicrobiome-Day7  : num [1:62] 757 38904 204 583 317 ...
    ##  $ ShotgunWGS-TomatoPig15GutMicrobiome-Day0  : num [1:62] 2037 120272 320 1399 561 ...
    ##  $ ShotgunWGS-TomatoPig12GutMicrobiome-Day7  : num [1:62] 1279 87121 215 917 409 ...
    ##  $ ShotgunWGS-TomatoPig14GutMicrobiome-Day14 : num [1:62] 583 36948 69 444 102 ...
    ##  $ ShotgunWGS-TomatoPig20GutMicrobiome-Day14 : num [1:62] 496 29179 99 374 142 ...
    ##  $ ShotgunWGS-ControlPig1GutMicrobiome-Day0  : num [1:62] 2963 90535 278 1596 631 ...
    ##  $ ShotgunWGS-ControlPig4GutMicrobiome-Day14 : num [1:62] 2548 133556 181 1734 432 ...
    ##  $ ShotgunWGS-ControlPig6GutMicrobiome-Day0  : num [1:62] 2269 127508 314 1058 413 ...
    ##  $ ShotgunWGS-TomatoPig16GutMicrobiome-Day0  : num [1:62] 1935 110140 207 1018 425 ...
    ##  $ ShotgunWGS-TomatoPig16GutMicrobiome-Day14 : num [1:62] 817 33981 133 443 187 ...
    ##  $ ShotgunWGS-TomatoPig18GutMicrobiome-Day14 : num [1:62] 705 92977 122 507 148 ...
    ##  $ ShotgunWGS-ControlPig7GutMicrobiome-Day7  : num [1:62] 1131 69602 297 628 290 ...
    ##  $ ShotgunWGS-ControlPig4GutMicrobiome-Day7  : num [1:62] 1298 112714 203 983 325 ...
    ##  $ ShotgunWGS-TomatoPig13GutMicrobiome-Day14 : num [1:62] 566 36447 72 514 125 ...
    ##  $ ShotgunWGS-ControlPig8GutMicrobiome-Day7  : num [1:62] 2173 159187 378 1311 361 ...
    ##  $ ShotgunWGS-TomatoPig15GutMicrobiome-Day14 : num [1:62] 1186 49134 150 858 249 ...
    ##  $ ShotgunWGS-TomatoPig12GutMicrobiome-Day14 : num [1:62] 1122 64744 254 1030 427 ...
    ##  $ ShotgunWGS-TomatoPig20GutMicrobiome-Day7  : num [1:62] 1109 97728 149 670 211 ...
    ##  $ ShotgunWGS-ControlPig1GutMicrobiome-Day14 : num [1:62] 2350 83993 210 1719 446 ...
    ##  $ ShotgunWGS-ControlPig3GutMicrobiome-Day0  : num [1:62] 3314 428097 206 2366 519 ...
    ##  $ ShotgunWGS-ControlPig5GutMicrobiome-Day0  : num [1:62] 2998 242356 283 1895 758 ...
    ##  $ ShotgunWGS-ControlPig4GutMicrobiome-Day0  : num [1:62] 3042 223010 351 1777 685 ...
    ##  $ ShotgunWGS-ControlPig9GutMicrobiome-Day7  : num [1:62] 499 68424 784 329 171 ...
    ##  $ ShotgunWGS-ControlPig3GutMicrobiome-Day7  : num [1:62] 2620 340300 165 1993 484 ...
    ##  $ ShotgunWGS-TomatoPig17GutMicrobime-Day7   : num [1:62] 1340 71395 159 648 270 ...
    ##  $ ...63                                     : num [1:62] NA NA NA NA NA NA NA NA NA NA ...
...
```
    ...
    ## # A tibble: 10 × 5
    ##    domain    phylum                  ShotgunWGS-ControlPig6Gut…¹ Shotg…² Shotg…³
    ##    <chr>     <chr>                                         <dbl>   <dbl>   <dbl>
    ...
    ##  9 Eukaryota Blastocladiomycota                                0       0       0
    ## 10 Bacteria  Candidatus Poribacteria                          26      49      21
    ## # … with abbreviated variable names
    ## #   ¹​`ShotgunWGS-ControlPig6GutMicrobiome-Day14`,
    ## #   ²​`ShotgunWGS-ControlPig8GutMicrobiome-Day0`,
    ## #   ³​`ShotgunWGS-ControlPig3GutMicrobiome-Day14`
...
```
    ...
    ## # A tibble: 10 × 5
    ##    Sample_Name                               Pig   Diet    Time_Point Diet_By_…¹
    ##    <chr>                                     <fct> <fct>   <fct>      <fct>     
    ##  1 ShotgunWGS-ControlPig6GutMicrobiome-Day14 6     Control Day 14     Control D…
    ##  2 ShotgunWGS-ControlPig8GutMicrobiome-Day0  8     Control Day 0      Control D…
    ##  3 ShotgunWGS-ControlPig3GutMicrobiome-Day14 3     Control Day 14     Control D…
    ##  4 ShotgunWGS-TomatoPig14GutMicrobiome-Day7  14    Tomato  Day 7      Tomato Da…
    ##  5 ShotgunWGS-ControlPig5GutMicrobiome-Day7  5     Control Day 7      Control D…
    ##  6 ShotgunWGS-TomatoPig18GutMicrobiome-Day7  18    Tomato  Day 7      Tomato Da…
    ##  7 ShotgunWGS-TomatoPig16GutMicrobiome-Day7  16    Tomato  Day 7      Tomato Da…
    ##  8 ShotgunWGS-ControlPig10GutMicrobiome-Day7 10    Control Day 7      Control D…
    ##  9 ShotgunWGS-ControlPig2GutMicrobiome-Day0  2     Control Day 0      Control D…
    ## 10 ShotgunWGS-TomatoPig18GutMicrobiome-Day0  18    Tomato  Day 0      Tomato Da…
    ## # … with abbreviated variable name ¹​Diet_By_Time_Point
...
```
    ...
    ## # A tibble: 5 × 10
    ##   Sample_N…¹ Pig   Diet  Time_…² Diet_…³ Acido…⁴ Actin…⁵ Apico…⁶ Aquif…⁷ Ascom…⁸
    ##   <chr>      <fct> <fct> <fct>   <fct>     <dbl>   <dbl>   <dbl>   <dbl>   <dbl>
    ## 1 ShotgunWG… 6     Cont… Day 14  Contro… 7.41e-4  0.0481 5.95e-5 5.03e-4 3.84e-4
    ## 2 ShotgunWG… 8     Cont… Day 0   Contro… 8.85e-4  0.0660 9.14e-5 5.37e-4 5.23e-4
    ## 3 ShotgunWG… 3     Cont… Day 14  Contro… 6.90e-4  0.0327 4.92e-5 4.25e-4 3.32e-4
    ## 4 ShotgunWG… 14    Toma… Day 7   Tomato… 7.32e-4  0.0329 1.40e-4 5.38e-4 5.59e-4
    ## 5 ShotgunWG… 5     Cont… Day 7   Contro… 6.56e-4  0.0463 5.57e-5 4.62e-4 3.84e-4
    ## # … with abbreviated variable names ¹​Sample_Name, ²​Time_Point,
    ## #   ³​Diet_By_Time_Point, ⁴​Acidobacteria, ⁵​Actinobacteria, ⁶​Apicomplexa,
    ## #   ⁷​Aquificae, ⁸​Ascomycota
...
``` r
ggsave("Figures/BetaDiversity_PCoA_Phyla_allsamples.svg", 
...
``` r
ggsave("Figures/BetaDiversity_PCoA_Phyla_FacetByTimePoint.svg", 
...
``` r
ggsave("Figures/BetaDiversity_PCoA_Phyla_FacetByDiet.svg", 
...
```
    ...
    ## # A tibble: 10 × 7
    ##    Sample_Name                        Pig   Diet  Time_…¹ Diet_…² phylum rel_a…³
    ##    <chr>                              <fct> <fct> <fct>   <fct>   <chr>    <dbl>
    ##  1 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Acido… 7.41e-4
    ##  2 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Actin… 4.81e-2
    ##  3 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Apico… 5.95e-5
    ##  4 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Aquif… 5.03e-4
    ##  5 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Ascom… 3.84e-4
    ##  6 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Bacil… 2.71e-5
    ##  7 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Bacte… 3.67e-1
    ##  8 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Basid… 6.18e-5
    ##  9 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Candi… 6.70e-6
    ## 10 ShotgunWGS-ControlPig6GutMicrobio… 6     Cont… Day 14  Contro… Chlam… 1.42e-4
...
```
    ...
    ##   Sample_Name                         Pig   Diet  Time_…¹ Diet_…² phylum rel_a…³
    ##   <chr>                               <fct> <fct> <fct>   <fct>   <chr>    <dbl>
    ## 1 ShotgunWGS-ControlPig6GutMicrobiom… 6     Cont… Day 14  Contro… Bacte…   0.367
    ## 2 ShotgunWGS-ControlPig6GutMicrobiom… 6     Cont… Day 14  Contro… Firmi…   0.531
    ## 3 ShotgunWGS-ControlPig6GutMicrobiom… 6     Cont… Day 14  Contro… Other…   0.102
    ## 4 ShotgunWGS-ControlPig8GutMicrobiom… 8     Cont… Day 0   Contro… Bacte…   0.331
    ## 5 ShotgunWGS-ControlPig8GutMicrobiom… 8     Cont… Day 0   Contro… Firmi…   0.529
    ## 6 ShotgunWGS-ControlPig8GutMicrobiom… 8     Cont… Day 0   Contro… Other…   0.139
    ## # … with abbreviated variable names ¹​Time_Point, ²​Diet_By_Time_Point,
    ## #   ³​rel_abund
...
```
    ...
    ##   Sample_Name                         Pig   Diet  Time_…¹ Diet_…² phylum rel_a…³
    ##   <chr>                               <fct> <fct> <fct>   <fct>   <chr>    <dbl>
    ## 1 ShotgunWGS-ControlPig6GutMicrobiom… 6     Cont… Day 14  Contro… BtoF     0.692
    ## 2 ShotgunWGS-ControlPig8GutMicrobiom… 8     Cont… Day 0   Contro… BtoF     0.626
    ## 3 ShotgunWGS-ControlPig3GutMicrobiom… 3     Cont… Day 14  Contro… BtoF     0.556
    ## 4 ShotgunWGS-TomatoPig14GutMicrobiom… 14    Toma… Day 7   Tomato… BtoF     0.662
    ## 5 ShotgunWGS-ControlPig5GutMicrobiom… 5     Cont… Day 7   Contro… BtoF     0.416
    ## 6 ShotgunWGS-TomatoPig18GutMicrobiom… 18    Toma… Day 7   Tomato… BtoF     0.870
    ## # … with abbreviated variable names ¹​Time_Point, ²​Diet_By_Time_Point,
    ## #   ³​rel_abund
...
``` r
ggsave("Figures/BacteroidotatoBacilottaRatio_Boxplot.svg", 
       plot = BtoF_Boxplot, 
       dpi = 800, 
       width = 7, 
       height = 5)
...
```
    ...
    ## 4 ShotgunWG… 14    Toma… Day 7   Tomato… 7.32e-4  0.0329 1.40e-4 5.38e-4 5.59e-4
    ## 5 ShotgunWG… 5     Cont… Day 7   Contro… 6.56e-4  0.0463 5.57e-5 4.62e-4 3.84e-4
    ## 6 ShotgunWG… 18    Toma… Day 7   Tomato… 7.72e-4  0.102  5.67e-5 3.69e-4 4.48e-4
    ## # … with 42 more variables: Bacillariophyta <dbl>, Bacteroidetes <dbl>,
    ## #   Basidiomycota <dbl>, `Candidatus Poribacteria` <dbl>, Chlamydiae <dbl>,
    ## #   Chlorobi <dbl>, Chloroflexi <dbl>, Chlorophyta <dbl>, Chrysiogenetes <dbl>,
    ## #   Crenarchaeota <dbl>, Cyanobacteria <dbl>, Deferribacteres <dbl>,
    ## #   `Deinococcus-Thermus` <dbl>, Dictyoglomi <dbl>, Elusimicrobia <dbl>,
    ## #   Euryarchaeota <dbl>, Fibrobacteres <dbl>, Firmicutes <dbl>,
    ## #   Fusobacteria <dbl>, Gemmatimonadetes <dbl>, Hemichordata <dbl>, …
...
```
    ...
    ## # A tibble: 6 × 11
    ##   Diet    .y.   group1 group2    n1    n2 statistic    df     p p.adj p.adj.si…¹
    ## * <fct>   <chr> <chr>  <chr>  <int> <int>     <dbl> <dbl> <dbl> <dbl> <chr>     
    ## 1 Control BtoF  Day 0  Day 7     10    10     1.34      9 0.213 0.32  ns        
    ## 2 Control BtoF  Day 0  Day 14    10    10     3.19      9 0.011 0.033 *         
    ## 3 Control BtoF  Day 7  Day 14    10    10     0.589     9 0.571 0.571 ns        
    ## 4 Tomato  BtoF  Day 0  Day 7     10    10     0.403     9 0.696 0.696 ns        
    ## 5 Tomato  BtoF  Day 0  Day 14    10    10     1.35      9 0.211 0.633 ns        
    ## 6 Tomato  BtoF  Day 7  Day 14    10    10     0.812     9 0.438 0.657 ns        
...
``` r
ggsave("Figures/BacteroidotaBacilotta_Boxplot.svg", 
       plot = BandF_Boxplot, 
       dpi = 800, 
       width = 7, 
       height = 5)
...
```
    ...
    ## * <chr>         <chr>  <chr>  <int> <int>     <dbl> <dbl> <dbl> <dbl> <chr>     
    ## 1 Bacteroidetes Day 0  Day 7     20    20     1.62     19 0.122 0.183 ns        
    ## 2 Bacteroidetes Day 0  Day 14    20    20     2.56     19 0.019 0.058 ns        
    ## 3 Bacteroidetes Day 7  Day 14    20    20     0.572    19 0.574 0.574 ns        
    ## # … with abbreviated variable name ¹​p.adj.signif
...
```
    ...
    ## # A tibble: 6 × 11
    ##   Diet    .y.        group1 group2    n1    n2 stati…¹    df     p p.adj p.adj…²
    ## * <fct>   <chr>      <chr>  <chr>  <int> <int>   <dbl> <dbl> <dbl> <dbl> <chr>  
    ## 1 Control Bacteroid… Day 0  Day 7     10    10   1.56      9 0.154 0.231 ns     
    ## 2 Control Bacteroid… Day 0  Day 14    10    10   3.02      9 0.015 0.044 *      
    ## 3 Control Bacteroid… Day 7  Day 14    10    10   0.152     9 0.883 0.883 ns     
    ## 4 Tomato  Bacteroid… Day 0  Day 7     10    10   0.486     9 0.638 0.638 ns     
    ## 5 Tomato  Bacteroid… Day 0  Day 14    10    10   1.08      9 0.308 0.638 ns     
    ## 6 Tomato  Bacteroid… Day 7  Day 14    10    10   0.495     9 0.633 0.638 ns     
...
```
    ...
    ##   .y.        group1 group2    n1    n2 statistic    df        p p.adj p.adj.si…¹
    ## * <chr>      <chr>  <chr>  <int> <int>     <dbl> <dbl>    <dbl> <dbl> <chr>     
    ## 1 Firmicutes Day 0  Day 7     20    20     -1.60    19 0.125    0.125 ns        
    ## 2 Firmicutes Day 0  Day 14    20    20     -3.93    19 0.000907 0.003 **        
    ## 3 Firmicutes Day 7  Day 14    20    20     -1.67    19 0.111    0.125 ns        
    ## # … with abbreviated variable name ¹​p.adj.signif
...
```
    ...
    ##   Diet    .y.        group1 group2    n1    n2 stati…¹    df     p p.adj p.adj…²
    ## * <fct>   <chr>      <chr>  <chr>  <int> <int>   <dbl> <dbl> <dbl> <dbl> <chr>  
    ## 1 Control Firmicutes Day 0  Day 7     10    10  -1.48      9 0.173 0.259 ns     
    ## 2 Control Firmicutes Day 0  Day 14    10    10  -3.25      9 0.01  0.03  *      
    ## 3 Control Firmicutes Day 7  Day 14    10    10  -0.843     9 0.421 0.421 ns     
    ## 4 Tomato  Firmicutes Day 0  Day 7     10    10  -0.550     9 0.596 0.596 ns     
    ## 5 Tomato  Firmicutes Day 0  Day 14    10    10  -1.96      9 0.082 0.246 ns     
    ## 6 Tomato  Firmicutes Day 7  Day 14    10    10  -1.05      9 0.322 0.483 ns     
    ## # … with abbreviated variable names ¹​statistic, ²​p.adj.signif
...
``` r
ggsave("Figures/AlphaDiversityPhyla_ByDiet_Boxplot.svg", 
...
``` r
ggsave("Figures/AlphaDiversityPhyla_ByTime_Boxplot.svg", 
...
```
    ...
    ## # A tibble: 3 × 11
    ##   Time_Point .y.     group1 group2    n1    n2 stati…¹    df     p p.adj p.adj…²
    ## * <fct>      <chr>   <chr>  <chr>  <int> <int>   <dbl> <dbl> <dbl> <dbl> <chr>  
    ## 1 Day 0      shanno… Contr… Tomato    10    10   -1.03     9 0.328 0.328 ns     
    ## 2 Day 7      shanno… Contr… Tomato    10    10   -1.93     9 0.085 0.085 ns     
    ## 3 Day 14     shanno… Contr… Tomato    10    10   -3.21     9 0.011 0.011 *      
    ## # … with abbreviated variable names ¹​statistic, ²​p.adj.signif
...
```
    ...
    ## # A tibble: 10 × 10
    ##    domain phylum Shotg…¹ Shotg…² Shotg…³ Shotg…⁴ Shotg…⁵ Shotg…⁶ Shotg…⁷ Shotg…⁸
    ##    <chr>  <chr>    <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>   <dbl>
    ##  1 Bacte… Acido…    2874    3717    2663     880    2016    1377    1570    1298
    ##  2 Bacte… Actin…  186789  277130  126155   39557  142345  181295   58263  109273
    ##  3 Eukar… Apico…     231     384     190     168     171     101     224     287
    ##  4 Bacte… Aquif…    1953    2254    1642     647    1418     658     892     900
    ##  5 Eukar… Ascom…    1491    2196    1281     672    1178     799    1720     763
    ##  6 Eukar… Bacil…     105     184     129      65     111      64      80      65
    ##  7 Bacte… Bacte… 1424565 1391417 1260217  415935  798569  690378  826292  757469
    ##  8 Eukar… Basid…     240     405     198     114     182     119     199     111
    ##  9 Eukar… Blast…       0       0       0       0       1       0       0       0
    ## 10 Bacte… Candi…      26      49      21      17      22      17      21      23
    ## # … with abbreviated variable names
    ## #   ¹​`ShotgunWGS-ControlPig6GutMicrobiome-Day14`,
    ## #   ²​`ShotgunWGS-ControlPig8GutMicrobiome-Day0`,
    ## #   ³​`ShotgunWGS-ControlPig3GutMicrobiome-Day14`,
    ## #   ⁴​`ShotgunWGS-TomatoPig14GutMicrobiome-Day7`,
    ## #   ⁵​`ShotgunWGS-ControlPig5GutMicrobiome-Day7`,
    ## #   ⁶​`ShotgunWGS-TomatoPig18GutMicrobiome-Day7`, …
...
Phyla and genera, subset by time point
...
``` r
(PCoA_phyla_20zeros_facetbytime / PCoA_genera_20zeros_facetbytime) + plot_annotation(tag_levels = 'A')
```

![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-234-1.png)<!-- -->

``` r
ggsave("Figures/Fig2.svg", 
       width = 10, 
       height = 8)
```
...
``` r
(bacteriodetes <- RelAbund.Phyla.Filt.zerofilt.withother.BtoF.long.OnlyBandF %>%
  filter(phylum == "Bacteroidetes") %>%
  ggplot(aes(x=Diet, y=rel_abund, fill=Diet_By_Time_Point))+
  geom_boxplot(outlier.shape = NA)+
  geom_point(aes(fill = Diet_By_Time_Point), color = "black", position=position_jitterdodge(), alpha = 0.7) +
  geom_segment(aes(x = 0.75, xend = 1.25, y = 0.5, yend = 0.5)) +
  annotate(geom = "text", x = 1, y = 0.52, label = "P = 0.044") +
  scale_fill_manual(values=c("skyblue1", "dodgerblue", "royalblue4", "sienna1","firebrick3","tomato4"))+
  ylim(0, 0.75) +
  theme_bw() +
  labs(x=NULL, 
...
![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-236-1.png)<!-- -->

``` r
(firmicutes <- RelAbund.Phyla.Filt.zerofilt.withother.BtoF.long.OnlyBandF %>%
  filter(phylum == "Firmicutes") %>%
  ggplot(aes(x=Diet, y=rel_abund, fill=Diet_By_Time_Point))+
  geom_boxplot(outlier.shape = NA)+
  geom_point(aes(fill = Diet_By_Time_Point), color = "black", position=position_jitterdodge(), alpha = 0.7) +
  geom_segment(aes(x = 0.75, xend = 1.25, y = 0.68, yend = 0.68)) +
  annotate(geom = "text", x = 1, y = 0.70, label = "P = 0.03") +
  scale_fill_manual(values=c("skyblue1", "dodgerblue", "royalblue4", "sienna1","firebrick3","tomato4"))+
  ylim(0, 0.75) +
  theme_bw() +
  labs(x=NULL, 
...
![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-236-2.png)<!-- -->

``` r
(BtoFplot <- BtoF_Boxplot +
  geom_segment(aes(x = 0.75, xend = 1.25, y = 0.9, yend = 0.9)) +
  annotate(geom = "text", x = 1, y = 0.92, label = "P = 0.033"))
```
...
![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-236-3.png)<!-- -->

``` r
bacteriodetes + firmicutes + BtoFplot
```

    ## Warning: Removed 5 rows containing non-finite values (stat_boxplot).
    ## Removed 5 rows containing missing values (geom_point).

![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-236-4.png)<!-- -->
...
### Fig4 alpha-diversity

``` r
(alpha_phyla <- alpha.diversity.phyla.bytime +
  geom_segment(aes(x = 2.75, xend = 3.25, y = 1.3, yend = 1.3)) +
  annotate(geom = "text", x = 3, y = 1.32, label = "P = 0.011") +
  theme(legend.position = "none"))
```

![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-238-1.png)<!-- -->

``` r
(alpha_genera <- alpha.diversity.genera.bytime)
```

![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-238-2.png)<!-- -->

``` r
(alpha_phyla + alpha_genera) + plot_annotation(tag_levels = 'A') 
```

![](Goggans_TomatoPigMicrobiomeAnalysis_files/figure-gfm/unnamed-chunk-238-3.png)<!-- -->
